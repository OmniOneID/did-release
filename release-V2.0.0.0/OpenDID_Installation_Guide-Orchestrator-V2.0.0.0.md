...
1. **Installation Overview**: Guides the entire installation process of the Open DID platform.

2. **System Requirements**: Explains the system requirements needed to run the project.
   - Explains system requirements for installing Open DID components (blockchain, server, App).

3. **Prerequisites**: Guides the preparatory work needed before starting installation.
   - Guides Git installation method.
   - Guides Gradle installation method.

4. **Installation and Registration**: Explains how to install each component of Open DID through Orchestrator and register the installed servers in the Open DID system.
   - Explains blockchain installation method.
   - Explains database installation method.
   - Explains how to install and run each server.
   - Explains how to register installed servers in the OpenDID system.
   - Explains Demo server installation method.
   - Explains App (Android, iOS) installation method.
