...
- [2. Installation Overview](#2-installation-overview)
  - [2.1. Orchestrator를 활용한 빠른 설치 (선택 사항)](#21-orchestrator를-활용한-빠른-설치-선택-사항)
    - [2.1.1. Orchestrator 설치](#211-orchestrator-설치)
    - [2.1.2. Orchestrator 설치 후 서버별 설치 방법](#212-orchestrator-설치-후-서버별-설치-방법)
    - [2.1.3. Orchestrator 설치 후 서버별 Admin 설정 항목](#213-orchestrator-설치-후-서버별-admin-설정-항목)
...
## 2.1. Orchestrator를 활용한 빠른 설치 (선택 사항)
...
> ⚠️ **Orchestrator는 선택사항입니다.**  
> Orchestrator 사용을 원하지 않는 경우, 3장부터 가이드를 따라 각 단계별로 진행하시면 됩니다.
...
### 2.1.2. Orchestrator 설치 후 서버별 설치 방법
...
> ⚠️ 설치가 완료되더라도, 각 서버의 Admin 페이지에서 수동으로 설정해야 할 항목들이 존재합니다.  
> 자세한 내용은 [2.1.3 Orchestrator 설치 후 서버별 Admin 설정 항목](#213-orchestrator-설치-후-서버별-admin-설정-항목) 섹션을 참고해 주세요.


<br/>

### 2.1.3. Orchestrator 설치 후 서버별 Admin 설정 항목

Orchestrator를 사용하면 주요 구성요소를 쉽게 설치할 수 있지만,  
**설치 후 각 서버의 Admin 페이지에서 반드시 수동으로 진행해야 하는 설정들이 존재합니다.**  

아래 표를 참고하여 누락 없이 설정을 완료해 주세요.

| 구성 요소 | 설정 항목 | 문서 위치   | 설명      |
| --------- | --------- | ----------- | --------- |
| TA        | 작성 필요 | `작성 필요` | 작성 필요 |
| Issuer    | 작성 필요 | `작성 필요` | 작성 필요 |
| Verifier  | 작성 필요 | `작성 필요` | 작성 필요 |
| CA        | 작성 필요 | `작성 필요` | 작성 필요 |
| Wallet    | 작성 필요 | `작성 필요` | 작성 필요 |
